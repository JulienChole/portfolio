	...
	<div id="page">
		...
		<div id="mySidenav" class="sidenav">
  		...
  		<div id="main">
  			...
  			<div id="parcours">
  				<a id="titre"><b>Mes <p1>Compétences</p1></b></a>
  			</div>

  			<div class="dev">
  				<h2><b>Développement</b></h2>
